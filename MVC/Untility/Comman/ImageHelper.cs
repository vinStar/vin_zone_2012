...
namespace Common
{
    public class ImageHelper
    {
        ...
        {
            byte[] _ImageBytes = File.ReadAllBytes(FilesHelper.GetMapPath(imgPath));
            Image img = Image.FromStream(new System.IO.MemoryStream(_ImageBytes));
            filename = HttpContext.Current.Server.MapPath(filename);

            if (watermarkFilename.StartsWith("/") == false)
                watermarkFilename = "/" + watermarkFilename;
            watermarkFilename = FilesHelper.GetMapPath(watermarkFilename);
        ...
        {
            System.Drawing.Image originalImage = System.Drawing.Image.FromFile(FilesHelper.GetMapPath(originalImagePath));
            int towidth = width;
            int toheight = height;
            ...
            {
                //保存缩略图
                bitmap.Save(FilesHelper.GetMapPath(thumbnailPath));
            }
